...
public class CollectionDao extends AbstractDao<Collection, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Local_created_at = new Property(6, String.class, "local_created_at", false, "LOCAL_CREATED_AT");
        public final static Property Local_updated_at = new Property(7, String.class, "local_updated_at", false, "LOCAL_UPDATED_AT");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLLECTION\" (" + //
                ...
                "\"LOCAL_CREATED_AT\" TEXT," + // 6: local_created_at
                "\"LOCAL_UPDATED_AT\" TEXT);"); // 7: local_updated_at
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Collection entity) {
        ...
        String local_created_at = entity.getLocal_created_at();
        if (local_created_at != null) {
            stmt.bindString(7, local_created_at);
        }
 
        String local_updated_at = entity.getLocal_updated_at();
        if (local_updated_at != null) {
            stmt.bindString(8, local_updated_at);
        }
    }
    ...
    public Collection readEntity(Cursor cursor, int offset) {
        Collection entity = new Collection( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // local_created_at
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7) // local_updated_at
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Collection entity, int offset) {
        ...
        entity.setLocal_created_at(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setLocal_updated_at(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
     }
