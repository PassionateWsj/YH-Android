...
import com.intfocus.yh_android.constant.Permissions;
import com.intfocus.yh_android.util.LoadingUtils;
...
public abstract class BaseModeActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
    ...
    private String TAG = com.intfocus.yh_android.base.BaseActivity.class.getSimpleName();
