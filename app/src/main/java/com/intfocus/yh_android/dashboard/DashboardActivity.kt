...
import com.intfocus.yh_android.bean.DashboardItemBean
import com.intfocus.yh_android.dashboard.kpi.bean.NoticeBoardRequest
import com.intfocus.yh_android.dashboard.mine.PassWordAlterActivity
import com.intfocus.yh_android.dashboard.mine.bean.PushMessageBean
...
import com.intfocus.yh_android.db.OrmDBHelper
...
import com.intfocus.yh_android.subject.template_v2.ModularTwo_Mode_Activity
import com.intfocus.yh_android.util.*
import com.intfocus.yh_android.view.NoScrollViewPager
...
class DashboardActivity : FragmentActivity(), ViewPager.OnPageChangeListener, AdvTextSwitcher.Callback {
    ...
    fun handlePushMessage(message: String) {
        ...
        when (pushMessage.type) {
            "report" -> pageLink(pushMessage.title + "", pushMessage.url + "", pushMessage.obj_type, pushMessage.obj_id)
            "analyse" -> {
