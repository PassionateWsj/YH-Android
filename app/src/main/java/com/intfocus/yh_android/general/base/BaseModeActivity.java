...
import com.intfocus.yh_android.general.constant.Permissions;
import com.intfocus.yh_android.general.util.LoadingUtils;
...
public abstract class BaseModeActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
    ...
    private String TAG = com.intfocus.yh_android.general.base.BaseActivity.class.getSimpleName();
