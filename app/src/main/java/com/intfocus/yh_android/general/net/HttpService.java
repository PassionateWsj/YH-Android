package com.intfocus.yh_android.general.net;

import com.intfocus.yh_android.general.data.request.CommentBody;
import com.intfocus.yh_android.general.data.request.RequestFavourite;
import com.intfocus.yh_android.general.data.response.BaseResult;
import com.intfocus.yh_android.general.data.response.article.ArticleResult;
import com.intfocus.yh_android.general.data.response.assets.AssetsResult;
import com.intfocus.yh_android.general.data.response.filter.MenuResult;
import com.intfocus.yh_android.general.data.response.home.HomeMsgResult;
import com.intfocus.yh_android.general.data.response.home.KpiResult;
import com.intfocus.yh_android.general.data.response.home.ReportListResult;
import com.intfocus.yh_android.general.data.response.home.WorkBoxResult;
import com.intfocus.yh_android.general.data.response.login.RegisterResult;
import com.intfocus.yh_android.general.data.response.mine_page.NoticeContentResult;
import com.intfocus.yh_android.general.data.response.mine_page.UserInfoResult;
import com.intfocus.yh_android.general.data.response.notice.NoticesResult;
import com.intfocus.yh_android.general.data.response.scanner.NearestStoresResult;
import com.intfocus.yh_android.general.data.response.scanner.StoreListResult;
import com.intfocus.yh_android.general.util.K;
import com.intfocus.yh_android.business.login.bean.Device;
import com.intfocus.yh_android.business.login.bean.DeviceRequest;
import com.intfocus.yh_android.business.login.bean.NewUser;
