...
import com.intfocus.hxtest.general.constant.Permissions;
import com.intfocus.hxtest.general.util.LoadingUtils;
...
public abstract class BaseModeActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
    ...
    private String TAG = com.intfocus.hxtest.general.base.BaseActivity.class.getSimpleName();
