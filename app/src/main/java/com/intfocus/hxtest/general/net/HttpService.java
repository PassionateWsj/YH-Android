...
import com.intfocus.hxtest.general.data.request.CommentBody;
import com.intfocus.hxtest.general.data.request.RequestFavourite;
import com.intfocus.hxtest.general.data.response.BaseResult;
import com.intfocus.hxtest.general.data.response.article.ArticleResult;
import com.intfocus.hxtest.general.data.response.assets.AssetsResult;
import com.intfocus.hxtest.general.data.response.filter.MenuResult;
import com.intfocus.hxtest.general.data.response.home.HomeMsgResult;
import com.intfocus.hxtest.general.data.response.home.KpiResult;
import com.intfocus.hxtest.general.data.response.home.ReportListResult;
import com.intfocus.hxtest.general.data.response.home.WorkBoxResult;
import com.intfocus.hxtest.general.data.response.login.RegisterResult;
import com.intfocus.hxtest.general.data.response.mine_page.NoticeContentResult;
import com.intfocus.hxtest.general.data.response.mine_page.UserInfoResult;
import com.intfocus.hxtest.general.data.response.notice.NoticesResult;
import com.intfocus.hxtest.general.data.response.scanner.NearestStoresResult;
import com.intfocus.hxtest.general.data.response.scanner.StoreListResult;
import com.intfocus.hxtest.general.util.K;
import com.intfocus.hxtest.business.login.bean.Device;
import com.intfocus.hxtest.business.login.bean.DeviceRequest;
import com.intfocus.hxtest.business.login.bean.NewUser;
