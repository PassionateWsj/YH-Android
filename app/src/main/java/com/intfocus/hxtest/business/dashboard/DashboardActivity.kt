package com.intfocus.hxtest.business.dashboard
...
import com.intfocus.hxtest.business.dashboard.adapter.DashboardFragmentAdapter
import com.intfocus.hxtest.business.dashboard.kpi.KpiFragment
import com.intfocus.hxtest.business.dashboard.mine.MineFragment
import com.intfocus.hxtest.business.dashboard.mine.bean.PushMessageBean
import com.intfocus.hxtest.business.dashboard.report.ReportFragment
import com.intfocus.hxtest.business.dashboard.workbox.WorkBoxFragment
import com.intfocus.hxtest.business.scanner.BarCodeScannerActivity
import com.intfocus.hxtest.business.subject.template.five.TemplateFiveActivity
import com.intfocus.hxtest.business.subject.template.one.TemplateOneActivity
import com.intfocus.hxtest.business.subject.template.three.TemplateThreeActivity
import com.intfocus.hxtest.business.subject.template.two.SubjectActivity
import com.intfocus.hxtest.business.subject.webapplication.WebApplicationActivity
import com.intfocus.hxtest.business.subject.webapplication.WebApplicationActivityV6
...
import com.intfocus.hxtest.general.data.response.scanner.StoreListResult
import com.intfocus.hxtest.general.db.OrmDBHelper
...
import com.intfocus.hxtest.general.util.ActionLogUtil
...
import com.intfocus.hxtest.general.view.NoScrollViewPager
import com.intfocus.hxtest.general.view.TabView
...
//    }
    ...
    fun onMessageEvent(items: DashboardItemBean?) {
        if (items != null) {
            ...
            pageLink(objTitle!!, link!!, objectId!!, templateId!!, objectType!!, paramsMappingBean)
        } else {
