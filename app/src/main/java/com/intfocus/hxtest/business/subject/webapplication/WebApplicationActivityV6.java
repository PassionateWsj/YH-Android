package com.intfocus.hxtest.business.subject.webapplication;
...
import com.intfocus.hxtest.business.dashboard.mine.adapter.FilterMenuAdapter;
import com.intfocus.hxtest.general.base.BaseActivity;
import com.intfocus.hxtest.general.constant.ToastColor;
import com.intfocus.hxtest.general.data.response.filter.Menu;
import com.intfocus.hxtest.general.data.response.filter.MenuItem;
import com.intfocus.hxtest.general.data.response.filter.MenuResult;
import com.intfocus.hxtest.general.filter.MyFilterDialogFragment;
...
import com.intfocus.hxtest.general.view.addressselector.FilterPopupWindow;
...
public class WebApplicationActivityV6 extends BaseActivity implements OnPageChangeListener, OnLoadCompleteListener, OnErrorOccurredListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menuAdapter = new FilterMenuAdapter(mContext, menuDatas, this);
        filterRecyclerView.setAdapter(menuAdapter);
