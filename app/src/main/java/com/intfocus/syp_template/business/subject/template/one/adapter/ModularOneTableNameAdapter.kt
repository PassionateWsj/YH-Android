package com.intfocus.syp_template.business.subject.templateone.adapter
...
class ModularOneTableNameAdapter(private val ctx: Context, ltdata: List<com.intfocus.syp_template.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>) : BaseAdapter() {
    ...
    private fun setData(ltdata: List<com.intfocus.syp_template.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>?) {
        if (ltdata == null)
            return
        this.ltdata = ltdata
    }

    fun updateData(ltdata: List<com.intfocus.syp_template.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>) {
        setData(ltdata)
