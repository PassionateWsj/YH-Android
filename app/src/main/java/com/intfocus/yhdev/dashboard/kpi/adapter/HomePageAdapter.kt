...
import com.intfocus.yhdev.dashboard.kpi.adapter.MyViewPagerAdapter
...
import com.intfocus.yhdev.view.AutoScrollViewPager
...
class HomePageAdapter(val context: Context,
   ...
   private val HOME_BOTTOM: Int = BUSINESS_OVERVIEW + 1// Bottom
    ...
    override fun getItemViewType(position: Int): Int = getMyItemViewType(datas!![position].index!!)
