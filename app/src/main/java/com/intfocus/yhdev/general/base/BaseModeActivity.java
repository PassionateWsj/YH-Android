...
import com.intfocus.yhdev.general.constant.Permissions;
import com.intfocus.yhdev.general.util.LoadingUtils;
...
public abstract class BaseModeActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
    ...
    private String TAG = com.intfocus.yhdev.general.base.BaseActivity.class.getSimpleName();
