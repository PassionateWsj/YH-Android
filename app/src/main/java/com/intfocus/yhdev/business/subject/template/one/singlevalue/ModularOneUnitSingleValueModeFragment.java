package com.intfocus.yhdev.business.subject.template.one.singlevalue;
...
import com.intfocus.yhdev.business.subject.templateone.singlevalue.SingleValueContract;
...
import static com.intfucos.yhdev.constant.Params.REPORT_TYPE_SINGLE_VALUE;
...
public class ModularOneUnitSingleValueModeFragment extends BaseModeFragment implements SingleValueContract.View {
    ...
    private void init() {
        ...
        Report report = reportDao.queryBuilder()
                .where(reportDao.queryBuilder().and(ReportDao.Properties.Uuid.eq(ModeImpl.getInstance().getUuid()), ReportDao.Properties.Type.eq(REPORT_TYPE_SINGLE_VALUE)))
                .unique();
