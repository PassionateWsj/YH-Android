package com.intfocus.yhdev.business.subject.template.one.curvechart;
...
import com.intfocus.yhdev.general.view.CustomCurveChartV2;
import com.intfocus.yhdev.general.view.RateCursor;
import com.intfocus.yhdev.business.subject.template.one.entity.MDRPUnitCurveChartEntity;
import com.intfocus.yhdev.business.subject.template.one.entity.MDRPUnitSeries;
import com.intfocus.yhdev.business.subject.template.one.mode.MDRPUnitCurveChartMode;
import com.intfocus.yhdev.business.subject.templateone.curvechart.CurveChartContract;
...
import static com.intfucos.yhdev.constant.Params.REPORT_TYPE_CHART;
...
public class ModularOneUnitCurveChartModeFragment extends BaseModeFragment<MDRPUnitCurveChartMode> implements CustomCurveChartV2.PointClickListener,CurveChartContract.View {
    ...
    private void init() {
        ...
        Report report = reportDao.queryBuilder()
                .where(reportDao.queryBuilder().and(ReportDao.Properties.Uuid.eq(ModeImpl.getInstance().getUuid()), ReportDao.Properties.Type.eq(REPORT_TYPE_CHART)))
                .unique();
