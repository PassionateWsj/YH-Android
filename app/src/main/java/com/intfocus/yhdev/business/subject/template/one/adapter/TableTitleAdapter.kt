...
class TableTitleAdapter(val context: Context,
                        private var data: List<com.intfocus.yhdev.business.subject.template.one.entity.MDetailUnitEntity>?,
                        var listener: NoticeItemListener) : RecyclerView.Adapter<TableTitleAdapter.NoticeMenuHolder>() {

    var inflater = LayoutInflater.from(context)

    fun setData(data: List<com.intfocus.yhdev.business.subject.template.one.entity.MDetailUnitEntity>?) {
        this.data = data
