package com.intfocus.yhdev.business.dashboard.kpi.mode
...
//        return String.format(K.K_KPI_API_DATA_PATH, ConfigConstants.kBaseUrl,
//                mUserSP.getString(URLs.kGroupId, "0"), mUserSP.getString(URLs.kRoleId, "0"))
//    }
//
//    private fun getMessageUrl(): String {
//        return String.format(K.K_MESSAGE_DATA_MOBILE_PATH, ConfigConstants.kBaseUrl, mUserSP.getString(URLs.kRoleId, "0"),
...
//
//    private fun getMessageUrl(): String {
//        return String.format(K.kMessageDataMobilePath, ConfigConstants.kBaseUrl, mUserSP.getString(URLs.kRoleId, "0"),
//                mUserSP.getString(URLs.kGroupId, "0"),
//                mUserSP.getString("user_id", "0"))
//    }
//
