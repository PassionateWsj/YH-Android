package com.intfocus.yhdev.business.subject.template.one.banner;
...
public class ModularOneUnitBannerModeFragment extends BaseModeFragment {
    ...
    private void init() {
        ...
        Report report = reportDao.queryBuilder()
                .where(reportDao.queryBuilder().and(ReportDao.Properties.Uuid.eq(ModeImpl.getInstance().getUuid()), ReportDao.Properties.Type.eq(REPORT_TYPE_BANNER)))
                .unique();
