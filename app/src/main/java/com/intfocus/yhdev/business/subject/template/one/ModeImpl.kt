...
import com.intfocus.yhdev.business.subject.template.model.ReportModelImpl
...
class ModeImpl: ReportModelImpl() {
    ...
    fun getData(reportId: String, templateId: String, groupId: String) {
    ...
    fun analyseData(ctx: Context, groupId: String, reportId: String, callback: ModeModel.LoadDataCallback) {
