...
import com.intfocus.spy_template.general.data.request.CommentBody;
import com.intfocus.spy_template.general.data.request.RequestFavourite;
import com.intfocus.spy_template.general.data.response.BaseResult;
import com.intfocus.spy_template.general.data.response.article.ArticleResult;
import com.intfocus.spy_template.general.data.response.assets.AssetsResult;
import com.intfocus.spy_template.general.data.response.filter.MenuResult;
import com.intfocus.spy_template.general.data.response.home.HomeMsgResult;
import com.intfocus.spy_template.general.data.response.home.KpiResult;
import com.intfocus.spy_template.general.data.response.home.ReportListResult;
import com.intfocus.spy_template.general.data.response.home.WorkBoxResult;
import com.intfocus.spy_template.general.data.response.login.RegisterResult;
import com.intfocus.spy_template.general.data.response.mine_page.NoticeContentResult;
import com.intfocus.spy_template.general.data.response.mine_page.UserInfoResult;
import com.intfocus.spy_template.general.data.response.notice.NoticesResult;
import com.intfocus.spy_template.general.data.response.scanner.NearestStoresResult;
...
import com.intfocus.spy_template.business.login.bean.Device;
import com.intfocus.spy_template.business.login.bean.DeviceRequest;
import com.intfocus.spy_template.business.login.bean.NewUser;
