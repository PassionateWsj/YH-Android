...
import com.intfocus.spy_template.general.constant.Permissions;
import com.intfocus.spy_template.general.util.LoadingUtils;
...
public abstract class BaseModeActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
    ...
    private String TAG = com.intfocus.spy_template.general.base.BaseActivity.class.getSimpleName();
