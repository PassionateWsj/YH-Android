...
import com.intfocus.shengyiplus.subject.model.ReportModelImpl
import com.intfocus.shengyiplus.model.callback.LoadDataCallback
import com.intfocus.shengyiplus.ConfigConstants
import com.intfocus.shengyiplus.constant.Params.BODY
import com.intfocus.shengyiplus.constant.Params.CODE
import com.intfocus.shengyiplus.constant.Params.PATH
import com.intfocus.shengyiplus.util.*
import com.intfocus.shengyiplus.util.ApiHelper.deleteHeadersFile
    ...
    fun getReportData(reportId: String, templateId: String, groupID: String, callback: LoadDataCallback<String>) {
        ...
        observable = Observable.just(jsFileName)
                ...
                .map {
                    ...
                    if (File(htmlResponse["path"]).exists()) {
