package com.intfocus.shengyiplus.subject.one.module.tables.adapter
...
class TableTitleAdapter(val context: Context,
                        private var data: List<com.intfocus.shengyiplus.subject.one.entity.MDetailUnitEntity>?,
                        var listener: NoticeItemListener) : RecyclerView.Adapter<TableTitleAdapter.NoticeMenuHolder>() {

    var inflater = LayoutInflater.from(context)

    fun setData(data: List<com.intfocus.shengyiplus.subject.one.entity.MDetailUnitEntity>?) {
        this.data = data
