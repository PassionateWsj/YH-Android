...
import com.intfocus.shengyiplus.subject.one.module.banner.BannerFragment;
import com.intfocus.shengyiplus.subject.one.module.chart.ChartFragment;
import com.intfocus.shengyiplus.subject.one.module.bargraph.BargraphFragment;
import com.intfocus.shengyiplus.subject.one.module.singlevalue.SingleValueFragment;
import com.intfocus.shengyiplus.subject.one.module.tables.root.TableRootFragment;
import com.intfocus.shengyiplus.subject.one.module.tables.TableImpl;
import com.intfocus.shengyiplus.subject.one.module.tables.root.TableRootPresenter;
import com.intfocus.shengyiplus.subject.templateone.curvechart.ChartImpl;
import com.intfocus.shengyiplus.subject.templateone.curvechart.ChartPresenter;
import com.intfocus.shengyiplus.subject.templateone.singlevalue.SingleValueImpl;
import com.intfocus.shengyiplus.subject.templateone.singlevalue.SingleValuePresenter;
...
public class RootPageFragment extends Fragment implements RootPageContract.View {
    ...
    public void showData(@NotNull List<? extends Report> reports) {
        ...
        observable = Observable.from(reports)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<Report>() {
                    @Override
