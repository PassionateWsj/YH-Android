package com.intfocus.shengyiplus.dashboard.report
...
import com.intfocus.shengyiplus.dashboard.report.adapter.ReportsLeftListAdapter
import com.intfocus.shengyiplus.dashboard.report.adapter.ReportsRightRVAdapter
...
import com.intfocus.shengyiplus.subject.one.ReportContract
import com.intfocus.shengyiplus.subject.one.ReportImpl
...
class ReportFragment : BaseFragment(), ReportContract.View, ReportsLeftListAdapter.ReportLeftListListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ReportPresenter(ReportImpl.getInstance(), this)
    }
