package com.intfocus.shengyiplus.dashboard.mine.activity
...
import com.intfocus.shengyiplus.constant.Params.PASSWORD
    ...
    fun submitPassword() {
        ...
        if (URLs.MD5(oldPassword) == mUserSP.getString(PASSWORD, "0")) {
            ...
            RetrofitUtil.getHttpService(applicationContext)
                    .updatePwd(mUserSP.getString(USER_NUM, "0"), URLs.MD5(newPassword))
                    .compose(RetrofitUtil.CommonOptions<BaseResult>())
                    .subscribe(object : CodeHandledSubscriber<BaseResult>() {
                        override fun onCompleted() {
                            mRequestDialog.dismiss()
                            val alertDialog = AlertDialog.Builder(this@AlterPasswordActivity)
                            alertDialog.setTitle("温馨提示")
                                    ...
                                    .setPositiveButton("重新登录") { _, _ ->
                                        ...
                                        val intent = Intent()
                                        intent.setClass(this@AlterPasswordActivity, LoginActivity::class.java)
                        ...
                        override fun onError(apiException: ApiException?) {
                            mRequestDialog.dismiss()
                            ToastUtils.show(this@AlterPasswordActivity, apiException!!.displayMessage!!)
                        }
