...
class SingleValueImpl : SingleValueModel {
    ...
    override fun getData(mParam: String, callback: SingleValueModel.LoadDataCallback) {
        Observable.just(mParam)
                ...
                .map { JSON.parseObject<com.intfocus.hx.business.subject.template.one.entity.MDRPUnitSingleValue>(it, com.intfocus.hx.business.subject.template.one.entity.MDRPUnitSingleValue::class.java) }
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(object : Observer<com.intfocus.hx.business.subject.template.one.entity.MDRPUnitSingleValue> {
                    override fun onNext(t: com.intfocus.hx.business.subject.template.one.entity.MDRPUnitSingleValue?) {
