package com.intfocus.hx.business.subject.templateone.adapter
 ...
 */
class ModularOneTableNameAdapter(private val ctx: Context, ltdata: List<com.intfocus.hx.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>) : BaseAdapter() {
    private var ltdata: List<com.intfocus.hx.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>? = null
    ...
    private fun setData(ltdata: List<com.intfocus.hx.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>?) {
        if (ltdata == null)
            return
        this.ltdata = ltdata
    }

    fun updateData(ltdata: List<com.intfocus.hx.business.subject.template.one.entity.ModularTwo_UnitTableEntity.TableRowEntity>) {
        setData(ltdata)
