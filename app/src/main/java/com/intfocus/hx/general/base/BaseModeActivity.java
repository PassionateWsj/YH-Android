package com.intfocus.hx.general.base;
...
import com.intfocus.hx.general.constant.Permissions;
import com.intfocus.hx.general.util.LoadingUtils;
...
public abstract class BaseModeActivity<T extends Subject> extends AbstractActivity<T> implements EasyPermissions.PermissionCallbacks {
    ...
    private String TAG = com.intfocus.hx.general.base.BaseActivity.class.getSimpleName();
