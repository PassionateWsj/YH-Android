package com.intfocus.hx.general.net;

import com.intfocus.hx.general.data.request.CommentBody;
import com.intfocus.hx.general.data.request.RequestFavourite;
import com.intfocus.hx.general.data.response.BaseResult;
import com.intfocus.hx.general.data.response.article.ArticleResult;
import com.intfocus.hx.general.data.response.assets.AssetsResult;
import com.intfocus.hx.general.data.response.filter.MenuResult;
import com.intfocus.hx.general.data.response.home.HomeMsgResult;
import com.intfocus.hx.general.data.response.home.KpiResult;
...
import com.intfocus.hx.general.data.response.mine_page.NoticeContentResult;
import com.intfocus.hx.general.data.response.mine_page.UserInfoResult;
import com.intfocus.hx.general.data.response.notice.NoticesResult;
import com.intfocus.hx.general.data.response.scanner.NearestStoresResult;
